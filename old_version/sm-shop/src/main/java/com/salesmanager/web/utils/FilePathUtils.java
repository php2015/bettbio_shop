...
public class FilePathUtils {
	protected static WorkModeConfiguration workMode;
	
	@Autowired
	private WorkModeConfiguration tWorkMode;
	@PostConstruct
    public void init() {
		FilePathUtils.workMode = tWorkMode;
    }
	...
	public static String buildStoreUri(MerchantStore store, HttpServletRequest request) {
		...
		if (!workMode.isProductEnv()){
			domainName = workMode.getDomainName();
		}
	...
	public static String buildStoreUrisELF(MerchantStore store, String contextPath) {
		StringBuilder resourcePath = new StringBuilder();
		String scheme = Constants.HTTP_SCHEME;
...
/*		StringBuilder resourcePath = new StringBuilder();
	...
	public static String buildAdminUri(MerchantStore store, HttpServletRequest request) {
		...
		.append(domainName)
		.append(request.getContextPath());
		// change URL in email according to new requirement
		// old is like this: .append(Constants.ADMIN_URI);
		resourcePath.append("/shop/customer/customLogon.html");
		
		return resourcePath.toString();
		
	}
	
	public static String buildCategoryUrl(MerchantStore store, String contextPath,String c) {
		StringBuilder resourcePath = new StringBuilder();
