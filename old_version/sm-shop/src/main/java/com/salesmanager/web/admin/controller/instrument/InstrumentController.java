package com.salesmanager.web.admin.controller.instrument;
...
public class InstrumentController {
	...
	@RequestMapping(value="/admin/instrument/editInstrument.html", method=RequestMethod.GET)
	...
	@PreAuthorize("hasRole('PRODUCTS')")
	@RequestMapping(value="/admin/instrument/createInstrument.html", method=RequestMethod.GET)
	...
	@PreAuthorize("hasRole('PRODUCTS')")
	@RequestMapping(value="/admin/instrument/stores.html", method={RequestMethod.GET,RequestMethod.POST}, produces="application/json")
	...
	@PreAuthorize("hasRole('PRODUCTS')")
	@RequestMapping(value="/admin/instrument/categorys.html", method=RequestMethod.POST, produces="application/json;charset=UTF-8")
	public @ResponseBody com.salesmanager.web.admin.entity.catalog.Category getCategorys(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			com.salesmanager.web.admin.entity.catalog.Category root = categoryNode.getRootInstrumentAndConsumer(request);
