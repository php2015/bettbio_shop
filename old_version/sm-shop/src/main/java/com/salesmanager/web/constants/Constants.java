...
//    public final static String DEFAULT_LANGUAGE = "en";
	...
	public final static String PERMISSION_DIAMOND_PRODUCT_CONTROLLER = "DIAMOND_PRODUCT_CONTROLLER";
	public final static String GROUP_ADMIN_DIAMOND_PRODUCT = "ADMIN_DIAMOND_PRODUCT";
...
//    public final static String REGIST_POINTS = "REGIST_POINTS"; //注册返积分
    //public final static String FORDER_POINTS = "FORDER_POINTS"; //首单返积分
    //#用户注册使用的积分
    public final static String REGIST_SCORE="REGIST_SCORE";
    //用户兑换积分
    public final static String EXCHANGE_SCORE="EXCHANGE_SCORE";
    //#下单积分比例
   ...
   // #推荐客户人数
    public final static String PERSONALNUMBER_NUM="PERSONALNUMBER_NUM";
    //#推荐客户人数满以后赠送的积分
    public final static String PERSONALNUMBER_SCORE="PERSONALNUMBER_SCORE";
	...
	public final static String LOGON_AS = "LOGON_AS";
	public final static String LOGON_AS_BUYER = "LOGON_AS_BUYER";
	public final static String LOGON_AS_SELLER = "LOGON_AS_SELLER";
    
	// User segement
	public final static String USER_SEGEMNT_LOGGED_CUSTOMER= "logged_customer";
