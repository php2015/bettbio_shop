...
public class PersistableProductReviewPopulator extends
	...
	public ProductReview populate(PersistableProductReview source,
		...
		try {
			...
			target.setReviewDate(com.salesmanager.web.utils.DateUtil.getDateByFormat("yyyy-MM-dd HH:mm:ss", source.getDate()));
			...
			OrderProduct orderProduct = orderProductService.getById(source.getOrderProductId());
			if(orderProduct ==null) {
				throw new ConversionException("Invalid orderProduct id for the given store");
			}
