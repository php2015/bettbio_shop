...
public interface OrderFacade {
	...
	OrderTotalSummary calculateOrderTotal(ShopOrder order) throws Exception;
	/**add by cy use for calc selected items**/
	OrderTotalSummary calculateOrderTotal(MerchantStore store,  List<ShoppingCartItem> items, Language language,Customer customer) throws Exception;
	/** used in the API **/
	...
	List<Country> getShipToCountry(MerchantStore store, Language language)
			throws Exception;
	//add by cy 
	PersistableCustomer getPersistableCustomer (Customer customer, MerchantStore store, Language language)throws Exception;
	
	ReadableOrderList getReadableOrderList(OrderCriteria criteria, Language language) throws Exception;
	
	ReadableOrderList getStoreReadableOrderList(OrderCriteria criteria, Language language) throws Exception;
	EzybioOrder getEzybioOrder(Long orderId,Language language,long storeID)throws Exception;
	
	void spiltSubOrder(String items)throws Exception;
	
	int deliverySubOrder(String subOrderId,String dCode,String dNo)throws Exception;
	
	SubOrder getSubOrderById(Long orderId,Language language)throws Exception;
	
	com.salesmanager.web.entity.order.SubOrder getSubOrderByStore(List<com.salesmanager.web.entity.order.SubOrder> subOrders,MerchantStore store)throws Exception;
	List<com.salesmanager.web.entity.order.SubOrder> setSubOrder(List<com.salesmanager.web.entity.order.SubOrder> subOrders,com.salesmanager.web.entity.order.SubOrder subOrder)throws Exception;
	/**
	...
	ReadableOrderList getReadableOrderList(Customer customer, int start,
