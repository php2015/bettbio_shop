...
<div id="sort_out" class="head-navbar-left" style="height:80px;width:1200px;" >
	<div class="" >
		...
		<div class="pull-left dropdown" aria-haspopup="true" aria-expanded="true" style="padding-left:120px;height:84px;font-size:18px;padding-top:20px; display: none;"><s:message code="label.generic.all" text="All" /><s:message code="label.bettbio.category" text="Category" /><b class="caret"></b>
		...
		<form id="searchForm"  method="post" action="<c:url value="/shop/search/search.html"/>" >
			...
			<div class="input-group <!-- nav-navbar-right -->" style="padding:0 100px 0 40px;">				
				<input id ="searchInput" name="q" type="text" class="form-control" 
					style="border: 1px solid #3c78d8;font-size:16px;border-radius:0px;" placeholder="请输入产品中（英）文名称或CAS" autocomplete="off" data-field="BB02"  spellcheck="false" dir="auto" value="<c:out value="${q}"/>"/>
