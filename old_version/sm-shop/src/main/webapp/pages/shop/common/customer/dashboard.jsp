...
<!-- From src\main\webapp\pages\shop\common\customer\dashboard.jsp -->
...
<div class="out">
	...
	<!-- 我的订单层 -->
	<div class="account_title"><span>我的订单</span><a href="<c:url value='/shop/customer/orders.html'/>" style="float:right;">查看更多</a></div>
