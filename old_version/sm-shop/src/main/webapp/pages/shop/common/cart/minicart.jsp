...
<div class="cartbox" id="cart-box" >
		...
		<div id="shoppingcart">
			...
			<button class="btn btn-large checkoutButton btn-info" style="width: 100%" type="button" onclick="viewShoppingCartPage();"><s:message code="label.checkout" text="Checkout"/></button>
		</div>
