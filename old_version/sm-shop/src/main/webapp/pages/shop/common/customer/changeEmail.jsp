					...
					<form method="post" action="${changeEmail}" id="changeEmailForm" class="form-horizontal">
						   <form:errors path="*" cssClass="alert-danger" element="div" />
							...
							<div class="form-group">
								...
								<strong style="font-size:20px;font-weight:bold"><s:message code="label.customer.safety.email" text="Change email"/></strong></label>
								<div class="col-sm-9">
							...
							<div class="form-group">
								<div class="col-sm-5 col-sm-offset-3">
									<input id="submitChangeEmail" class="btn  btn-disabled btn-info" type="submit" name="changeEmail" value="<s:message code="button.label.submit2" text="Change Email"/>" disabled="">
								</div>
							</div>			
							</fieldset>				
						</form>
