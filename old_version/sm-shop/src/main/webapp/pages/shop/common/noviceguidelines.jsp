...
<div class="head-navbar-left head-navbar-right" style="line-height:25px;">
	<div class="noviceguide">
		...
		<div class="noviceguide_head">
			<div class="noviceguide_title"><i class="glyphicon glyphicon-play"></i>&nbsp;&nbsp;卖家登录</div>
			<div class="noviceguide_part">
				1、登录后台管理页面，进入Bettbio主页点击右上角“<a href='<c:url value="/admin"/>' target='blank'><span class='font_i'>卖家管理</span></a>”。<br/>
			    <img src='<c:url value="/resources/img/guidelines/02.jpg"/>'/>
		    </div>
		    
		    <div class="noviceguide_part">
				2、输入平台分配给卖家的用户名和密码，点击“<span class='font_i'>登录</span>”，进入卖家主页面。<br/>
			    <img src='<c:url value="/resources/img/guidelines/03.jpg"/>'/>
		    </div>
			
			 <div class="noviceguide_part">
				3、进入卖家主页面，可以管理<mark>店铺、品牌、商品、订单以及用户基本信息</mark>。<br/>
	    ...
	    <div class="noviceguide_part">
			3、录入基本信息后，点击“<span class='font_i'>保存</span>”，会自动跳出商品规格价格、文献引用、购买凭证、第三方认证、自检报告等其他商品子标签，卖家可以点击相应标签进行相关信息的录入。<br/>
	    ...
	    <div class="noviceguide_part">
			6、商品信息维护后，平台会及时审核，并邮件通知卖家对应商品的审核结果，同时提示其产品质量信息还可进一步优化的环节。只有审核通过后，才可以在前台看到相应商品及其质量等级。<br/>
