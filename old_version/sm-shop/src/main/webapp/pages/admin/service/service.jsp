...
<script type="text/javascript">
	...
	$(function(){
		...
		$.ajax({
			type: 'POST',
			dataType: "json",
			url: '<c:url value="/admin/services/categorys.html" />',
	  ...
	  if('${operator}'=="new") {
		  ...
		  window.parent.window.loadProductTab(3);
    ...
    <div class="sm-ui-component">
	  ...
	  <c:choose>
		<c:when test="${product.product.id!=null && product.product.id>0}">
		  <script>
		    $("#productlabel", window.parent.document).html('<s:message code="label.service.edit" text="Edit product" />');
		...
		<c:otherwise>
		  <script>
		    $("#new_productlabel", window.parent.document).html('<s:message code="menu.catalogue-services-create" text="Create product" />');
		  </script>
		</c:otherwise>
	  </c:choose>
      ...
      <form:form method="POST" enctype="multipart/form-data" commandName="product" action="${productSave}" class="form-horizontal">
		<form:hidden path="product.id" />
                   	...
                   	<div class="row">
                   	  <div class="col-sm-4">
                   	    <label><s:message code="label.productedit.code" text="code"/>(必填且255位)</label>
                   	  ...
                   	  <div class="col-sm-4">
                   		...
                   		<input type="text" class="form-control" readonly id="cateName" value="${product.product.categoryName}"/>
                   		<form:hidden path="product.categoryId" id="cateId"/>
                   	...
                   	<div class="row">
                   	  ...
                   	  <div class="col-sm-4">
                   	    <label><s:message code="label.productedit.productenname" text="Product English name"/>(且最多512位)</label>
                   	...
                   	<div class="row">
                   	  <div class="col-sm-8">
                   	   ...
                   	   <div class="col-sm-4">
                   	    <label><s:message code="label.product.price" text="Price"/></label>
                   	    <form:input cssClass="form-control" id="sprice" path="product.serverPrice" />
                   	  </div>
                   	</div>
                   	  ...
                   	  <div class="col-sm-12">
                   	    ...
                   	    <div class="controls" id="imageControl">
                              <c:forEach var="images_search" items="${product.imagesName}">
                             	<div  style="margin-left:-14px" class="col-sm-2 pull-left"><span id="sp_imageId" hidden="hidden">${images_search.id}</span> <input type="file" name="image" id="image"   class="dropify-event" data-default-file="<sm:productImage imageName="${images_search.productImage}" product="${product.product}"/>"></div>
                              </c:forEach>
