  ...
  <div class="tab-content">
    ...
    <div class="sm-ui-component">
 	...
 	<%--   <c:url var="authSave" value="/admin/store/addAuth.html"/> --%>
      <form:form method="POST" enctype="multipart/form-data" commandName="auth" id="form" class="form-horizontal" onsubmit="">
		<form:hidden path="id" />
		<form:hidden path="auth_type" value="1"/>
                       ...
                       <script type="text/javascript">
                    	...
                    	<div class="row">
                   	  ...
                   	  <div class="col-sm-9" style="padding-top:5px">
                   	   ...
                   	   <table style="width:100%;height:100%;" border="0" cellpadding="0" cellspacing="0">
                   	     <tr>
                   	       <!--  <td style="width:50px;margin:30px 0 30px 26px;" class="search_padding_left">
				 				
				 			</td> -->
				 		    <td  id="manCatePanel" style="width:900px;margin:30px 0px ;">
				 		      <%-- <ul id="ul_list">
				 		        <c:forEach var="manus" items="${manus.manus}">
				 		           <li style="padding-left:15px;">${manus.name}</li><li hidden="hidden">${manus.id}</li>
				 		        </c:forEach>
				 		      </ul> --%>
                        ...
                        <%-- <ul id="chk_list"> 
                         <li><label>资质认证<s:message code="label.product.manufacturer" text="Manufacturer"/>:&nbsp;&nbsp;</label></li>
           	             <li><input  type="checkbox" id="all_chk" />[全不选]&nbsp;</li>
                      ...
                      <div class="collapse" id="collapseExample">
                   	...
                   	<div class="row">
                   	  <div class="col-sm-8" id="chargediv">
                   	    <label>资质认证<s:message code="label.bettbio.product.charge.perior" text="Charge Period"/>(必填)</label>
                   	...
                   	<div class="row">
                   	  <div class="col-sm-12">
                   	    ...
                   	    <form:textarea id="introduce" rows="3" cssClass="form-control" path="introduce" onkeydown='countChar("introduce","simpNum");' onKeyUp='countChar("introduce","simpNum");' onblur='countChar("introduce","simpNum");'/>
		...
		<div class="row">
		  <div class="col-sm-12">
			  <div class="pull-right">
	            <button id="bntSubmit1"  class="btn btn-success"><s:message code="button.label.submit" text="Submit"/></button>
	          </div>
      	 </div> 
