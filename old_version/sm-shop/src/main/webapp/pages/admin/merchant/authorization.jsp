...
<div class="table" id="showloading">
		...
		<div id="shop">
			<div style="padding:8px;"><a style="margin:10px;" href="javascript:void(0);" onclick="addAuth();">新增 厂家授权书</a></div>
			...
			<table id ="storelist" class="table table table-striped table-bordered table-hover">
				...
				<thead>
					<tr >
						...
						<th><%-- <s:message code="label.generic.remove" text="Del"/> --%>操作</th>
					</tr>
				</thead>
				<tbody>
	...
	<div class="modal-dialog" role="document" style="width:80%">  
    	<div class="modal-content">  
     		 <div class="modal-header"><button class="close" type="button" data-dismiss="modal">×</button>
				<h3 ><img src="<c:url value="/resources/img/important-icon.png"/>" width="40"/>&nbsp;<strong>厂家授权书</strong></h3>
			</div>
			<div class="modal-body" >
				<%-- <jsp:include page="/pages/shop/common/customer/editAddress.jsp" />	 --%>

				    <jsp:include page="/pages/admin/merchant/auth-model.jsp" />
