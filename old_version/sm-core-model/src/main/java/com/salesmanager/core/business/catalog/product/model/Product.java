...
public class Product extends SalesManagerEntity<Long, Product> implements Auditable {
	...
	@Column(name = "PRODUCT_DIAMOND")
	private boolean productIsDiamond =false; //标识产品是否钻石产品
	...
	public boolean isProductIsDiamond() {
		return productIsDiamond;
	}

	public void setProductIsDiamond(boolean productIsDiamond) {
		this.productIsDiamond = productIsDiamond;
	}
