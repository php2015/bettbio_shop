...
public interface ShoppingCartFacade {
    ...
    public ShoppingCartData getShoppingCartData(String code, MerchantStore store, Customer customer) throws Exception;
    ...
    public ShoppingCartData updateCartItem(final Long itemID, final String cartId, final long quantity,final MerchantStore store,Language language, Customer customer) throws Exception;
	...
	ShoppingCart deleteShoppingCart(ShoppingCart cart, final MerchantStore store) throws Exception;
