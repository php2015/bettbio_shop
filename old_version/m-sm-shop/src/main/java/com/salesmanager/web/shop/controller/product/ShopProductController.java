...
import com.salesmanager.core.utils.ProductPriceUtils.ProductPriceContext;
...
public class ShopProductController {
	...
	public String display(final String reference, final String friendlyUrl, Model model, HttpServletRequest request, HttpServletResponse response, Locale locale) throws Exception {
		...
		if (productProxy.getPrices() != null){
			...
			List<Long> pIds = Arrays.asList(new Long[]{pId});
			...
			if (productPriceDatas != null){
				...
				for(ReadableProductPrice price: productProxy.getPrices()){
