...
public class SearchController {
	...
	public String displayBrand(@RequestParam("brandName") String brandName, Model model, HttpServletRequest request, HttpServletResponse response, Locale locale) throws Exception {
		...
		/** template **/
		StringBuilder template = new StringBuilder("forward:/").append(ControllerConstants.Tiles.Search.search).append(".").append(store.getStoreTemplate());
		return template.toString();
	}
