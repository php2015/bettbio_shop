...
public interface ControllerConstants
{
    ...
    interface Tiles{
        ...
        interface Customer{
            ...
            final static String reType ="customerType";
            final static String storeRegister ="storeRegister";
            ...
            final static String addresss="customerAddress";
            final static String Billings="customerBillings";
