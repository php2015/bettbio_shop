...
//		Language fr = languageService.getByCode("fr");
		...
		ProductType generalType = productTypeService.getProductType(ProductType.GENERAL_TYPE);
		 ...
		 Category book = new Category();
		    ...
		    bookEnglishDescription.setLanguage(zh);
		    ...
		    novsEnglishDescription.setLanguage(zh);
		    ...
		    techEnglishDescription.setLanguage(zh);
		    ...
		    webEnglishDescription.setLanguage(zh);
		    ...
		    fictionEnglishDescription.setLanguage(zh);
		    ...
		    businessEnglishDescription.setLanguage(zh);
		    ...
		    cloudEnglishDescription.setLanguage(zh);
	...
	//	    product6.setProductWidth(new BigDecimal(1));
		   ...
		   // product6.setProductShipeable(true);
			...
			//remove by cy used for add muti billing && deliverycustomer.setAnonymous(false);
			//customer.setCompany("CSTI Consulting");
			customer.setDateOfBirth(new Date());

			customer.setDefaultLanguage(zh);
...
//		    billing.setCountryCode(canada.getIsoCode());
		  ...
		  //remove by cy used for add muti billing && delivery
			...
			*/
			...
			Currency currency = currencyService.getByCode(Constants.CURRENCY_CHINA_YUAN);
