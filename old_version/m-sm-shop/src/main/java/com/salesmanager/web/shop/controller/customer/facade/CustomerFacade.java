...
public interface CustomerFacade
{
    ...
    public CustomerEntity  registerCustomer( final PersistableCustomer customer,final MerchantStore merchantStore, final Language language, MemberPoints registPoints) throws Exception;
