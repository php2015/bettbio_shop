	...
	public PersistableCustomer populate(Customer source,
		...
		try {
			...
			*/
			...
			target.setCompany(source.getCompnay());
			if(source.getAddressDefault() !=null)target.setAddressDefault((long)source.getAddressDefault());
			if(source.getInvoiceaddressdefault() !=null) target.setInvoiceaddressdefault((long)source.getInvoiceaddressdefault());
			if(source.getInvoiceDefault() !=null) target.setInvoiceDefault((long)source.getInvoiceDefault());			
