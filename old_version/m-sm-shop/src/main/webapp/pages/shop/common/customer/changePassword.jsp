...
<div class="container-fluid"> 	
	...
	<div class="container-fluid" style="padding-bottom:10px;">
				<div class="pull-left" style="font-size:15px;padding-top:10px;"><s:message code="label.generic.changepassword" text="Change password"/></div>
						   ...
						   <form:errors path="*" cssClass="alert-danger" element="div" />
							...
							<div class="form-group">
								<div class="col-sm-5 col-sm-offset-3">
									<input id="submitChangePassword" class="btn  btn-disabled btn-info btn-block" type="submit" name="changePassword" value="<s:message code="menu.change-password" text="Change password"/>" disabled="">
								</div>
							</div>			
							</fieldset>				</form:form>
				</div>			
		<div class="col-sm-4 " style="padding-top:45px;">
			...
			<div id="formError"  class="alert alert-warning " style="display:none;position:fixed; top:57px;right:12px;"></div>
		</div>
</div>
</div>