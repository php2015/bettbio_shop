...
<div class="container-fluid">
	<div class="customer-box row">
		<div class="container-fluid" style="padding-bottom:10px;">
				<div class="pull-left" style="font-size:15px;padding-top:10px;"><s:message code="label.customer.billinginformation" text="Address"/><s:message code="label.bettbio.management" text="Management"/></div>
