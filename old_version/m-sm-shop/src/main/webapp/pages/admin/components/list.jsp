...
isc.HLayout.create({
    ID:"pageLayout",
    width: "<c:url value="${gridwidth}" />",
    height: "<c:url value="${gridheiht}" />",
    position:"relative",
    members:[
        isc.SectionStack.create({
            ...
            sections:[
                {title:"<s:message code="${componentTitleKey}" text="{componentTitleKey} UNDEFINED"/>", autoShow:false, items:[entityList]}
            ]
        })
    ]
});
