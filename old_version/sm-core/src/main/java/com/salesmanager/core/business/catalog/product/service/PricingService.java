...
public interface PricingService {
	...
	static final String PRICE_TYPE_BRAND_DISCOUNT = "brand_discount";
	static final String PRICE_TYPE_CUSTOMER_DISCOUNT = "customer_discount";
	static final String PRICE_TYPE_LIST_PRICE = "list_price";
	static final String PRICE_TYPE_TIMED_PROMOTION = "timed_promotion";
	...
	/** 根据上下文，计算一系列产品的展示价格 **/
	List<ProductPricingData> calculateProductListPrice(ProductPricingContext priceCtx, List<Long> prodIds);
}
