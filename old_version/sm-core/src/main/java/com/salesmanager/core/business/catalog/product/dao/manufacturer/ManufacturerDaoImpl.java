	...
	public List<Manufacturer> listByBrandAndStoreName(String brandName, String storeName) {
		...
		if (brandName != null && !brandName.isEmpty()){
			if (storeName != null && !storeName.isEmpty()){
				query.where(qManufacturerDescription.name.like("%"+brandName+"%").and(qManufacturer.merchantStore.storename.like("%"+storeName+"%")));
			}else{
				query.where(qManufacturerDescription.name.like("%"+brandName+"%"));
			}
		}else{
			if (storeName != null && !storeName.isEmpty()){
				query.where(qManufacturer.merchantStore.storename.like("%"+storeName+"%"));
			}else{
				// select all
			}
		}
