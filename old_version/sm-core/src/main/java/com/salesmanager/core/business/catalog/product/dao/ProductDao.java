...
public interface ProductDao extends SalesManagerEntityDao<Long, Product> {
	...
	ProductList listDiamondProductByStore(MerchantStore store, Language language, ProductCriteria criteria);
	ProductList listByCriteria(Language language, ProductCriteria criteria);
	
	ProductList listPsByCriteria_jdbc(Language language,ProductCriteria criteria);
	...
	List<Long> getIdsByNativeSql(String sqlStr);

	List<Long> getAllInvalidProductIdsByMerchantAndManufacturer(String storeName, List<Long> brandIds);

	List<Long> getAllInvalidProductIdsByMerchantName(String storeName);

	List<Long> getAllInvalidProductIdsByManufacturers(List<Long> brandIds);
