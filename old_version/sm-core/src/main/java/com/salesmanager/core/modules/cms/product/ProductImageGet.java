...
public interface ProductImageGet extends ImageGet{
	...
	public OutputContentFile getProductRelatedImage(final String merchantStoreCode, final String productCode, final String imageName, final String related) throws ServiceException;
