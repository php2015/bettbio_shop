...
public interface ManufacturerService extends SalesManagerEntityService<Long, Manufacturer> {
	...
	List<Manufacturer> getListByBrandName(String name);
	
	// query Manufacturer by piece of brand & store name
	List<Manufacturer> listByBrandAndStoreName(String brandName, String storeName);
	
	String getLogoImageUri(Manufacturer manufacturer, String postfix);
}
