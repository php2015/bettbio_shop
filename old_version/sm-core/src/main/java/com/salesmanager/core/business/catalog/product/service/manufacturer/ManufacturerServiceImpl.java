...
public class ManufacturerServiceImpl extends
	...
	@Override
	public List<Manufacturer> getListByBrandName(String name) {
		return manufacturerDao.getListByBrandName(name);
	}

	@Override
	public List<Manufacturer> listByBrandAndStoreName(String brandName, String storeName) {
		return manufacturerDao.listByBrandAndStoreName(brandName, storeName);
	}

	@Override
	public String getLogoImageUri(Manufacturer manufacturer, String postfix) {
		return GlobalConstants.IMAGE_URI_PREFIX_COMMON_IMAGE+"/"+GlobalConstants.IMAGE_URI_TYPE_BRAND_LOGO +"/"
				+manufacturer.getId()+ postfix;
	}
