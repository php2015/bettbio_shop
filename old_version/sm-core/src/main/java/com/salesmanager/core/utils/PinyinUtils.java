...
public class PinyinUtils {  
  ...
  public static String getSpell(String cnStr, boolean onlyFirstSpell) {  
	...
	public static void main(String[] args) {
		String[] s = { "获取汉字全拼和首拼测试", 
				"汉字和数字123以及字母ABC一起",
				"This is a test", "a,b; c[d]", "标，点。", "圆角数字１２３，特殊符号·￥%——……", "繁体字：西安會議", "西安",
				"棽 燊 顕 峣 山 " };
	...
	public static String getSortSpell(String strinput) {
		if (strinput == null){
			return "";
		}
		return getSpell(strinput.trim().toLowerCase(), false);
	}  
}