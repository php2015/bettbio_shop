...
public abstract class SalesManagerEntityServiceImpl<K extends Serializable & Comparable<K>, E extends SalesManagerEntity<K, ?>>
	...
	public List<E> getListByCriteria(Criteria criteria) {
		return genericDao.list();
	}
	 ...
	 */
	public <V> List<E> listByField(SingularAttribute<? super E, V> fieldName, V fieldValue) {
	...
	public List<E> findByProperties(String[] proNames, Object[] proValues, HashMap<String, String> orderby) {
		return genericDao.findByProperties(proNames, proValues, orderby);
	}
	...
	public void deleteByProperties(String[] proNames, Object[] proValues) {
		genericDao.deleteByProperties(proNames, proValues);
	}
	
	public List<E> findByPropertiesHQL(String[] proNames, Object[] proValues, HashMap<String, String> orderby) {
		return genericDao.findByPropertiesHQL(proNames, proValues, orderby);
	}
