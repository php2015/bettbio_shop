...
public class IsolatedTestCase
{
        ...
        throws ServiceException, IOException
    {
        ...
        final List<ProductImageDescription> image1descriptions = new ArrayList<ProductImageDescription>();
 ...
 //       product5.setProductLength( new BigDecimal( 3 ) );
  //      product5.setProductWidth( new BigDecimal( 1 ) );
        ...
        throws ServiceException
    {
		...
		try {
			...
			for(String key : configs.keySet()) {
				...
				IntegrationConfiguration c = configs.get(key);
        ...
        throws ServiceException
    {
        ...
        final Set<ManufacturerDescription> descriptions = new HashSet<ManufacturerDescription>();
        descriptions.add( fd );
        descriptions.add( ed );
