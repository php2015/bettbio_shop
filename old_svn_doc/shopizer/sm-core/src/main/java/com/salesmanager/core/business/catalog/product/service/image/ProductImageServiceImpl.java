...
public class ProductImageServiceImpl extends SalesManagerEntityServiceImpl<Long, ProductImage> 
	 ...
	 * @throws ServiceException
	 */
	public void addProductRelatedImage(Product product, ImageContentFile inputImage)
			throws ServiceException {
		try {
			
			Assert.notNull(inputImage.getFile(),"ImageContentFile.file cannot be null");
			productFileManager.addProductRelatedImage(product, inputImage);
	...
	@Override
	public OutputContentFile getProductRelatedImage(String storeCode, String productCode, String fileName, String related)
			throws ServiceException {
		OutputContentFile outputImage = productFileManager.getProductRelatedImage(storeCode, productCode, fileName, related);
		return outputImage;
	}
	...
	public void removeProductRelatedImage(Product product,
		...
		productFileManager.removeProductRelatedImage(product, certificateImage, related);
	}
}
