...
public class CategoryServiceImpl extends SalesManagerEntityServiceImpl<Long, Category> implements CategoryService {
	...
	public Map<String,Category> listTwoDepthByLanguage(MerchantStore store, Language language){
		return categoryDao.listTwoDepthByLanguage(store, language);
	}
	@Override
	...
	public List<Category> getByCateNameForServices(String name, Integer depth, Language language) {
		return categoryDao.getByCateNameForServices(name, depth, language);
	}
	...
	public List<Object[]> countProductsByCriteria(ProductCriteria criteria) {
		// TODO Auto-generated method stub
		return categoryDao.countProductsByCriteria(criteria);
	}
	...
	public List<Category> getByCateNameForOthers(String name, Integer depth,
			Language language) {
		// TODO Auto-generated method stub
		return categoryDao.getByCateNameForOthers(name, depth, language);
	}
}
