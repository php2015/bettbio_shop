...
public class ProductOptionValueServiceImpl extends
	...
	public ProductOptionValue getById(Long id) {
		ProductOptionValue o = productOptionValueDao.getById(id);
		o.getMerchantStore().getId();
		return o;
	...
	public OptionValueList getByCriteria(Criteria criteria,
		...
		return productOptionValueDao.getByCriteria(criteria, language);
	}

	@Override
	public List<ProductOptionValue> getListByCriteria(Criteria criteria){
		return productOptionValueDao.getListByCriteria(criteria);
	}
