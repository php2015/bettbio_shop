...
public class ProductRelationshipServiceImpl extends
	...
	@Override
	public ProductRelationsipList getByCriteria(Criteria criteria)
			throws ServiceException {
		// TODO Auto-generated method stub
		return productRelationshipDao.getByCritira(criteria);
	}
	
	@Override
	public List<ProductRelationship> getListByCriteria(Criteria criteria){
		return productRelationshipDao.getListByCriteria(criteria);
	}
	...
	public List<ProductRelationship> getByCodeProduct(String code, long id)
			throws ServiceException {
		// TODO Auto-generated method stub
		return productRelationshipDao.getByCodeProduct(code, id);
	}
