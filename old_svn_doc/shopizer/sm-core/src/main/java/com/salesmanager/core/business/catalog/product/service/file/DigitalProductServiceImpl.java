...
public class DigitalProductServiceImpl extends SalesManagerEntityServiceImpl<Long, DigitalProduct> 
	...
	@Override
	public List<DigitalProduct> getByProduct(MerchantStore store, Product product) throws ServiceException {
	...
	public List<DigitalProduct> queryByDigitalProduct(Long id){
		return this.digitalProductDao.queryByDigitalProduct(id);
	}
