...
public interface CustomerFacade
{
    ...
    public Customer getCustomerById(final Long id) throws Exception;
    ...
    public Customer getCustomerForLogin(final String user) throws Exception;
    
    public boolean checkIfUserExists(final String email,final String phone) throws Exception;
    
    public CustomerEntity  registerCustomer( final PersistableCustomer customer,final MerchantStore merchantStore, final Language language, MemberPoints registPoints,CustomerImage customerImage) throws Exception;
	...
	public Set<SubOrder> getSubOrders(Set<ShoppingCartItem> items,MerchantStore merchantStore, Language language)throws Exception;
	 ...
	 * @throws Exception 
	 * */
	public int valitationByCustomer(String phone,String emailAddress) throws Exception;
