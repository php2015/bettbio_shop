...
public class ReferenceController {
	...
	@RequestMapping(value="/shop/reference/countryName", method=RequestMethod.GET, produces="application/json;charset=UTF-8")
	...
	@RequestMapping(value="/shop/reference/zoneName",produces="application/json;charset=UTF-8")
