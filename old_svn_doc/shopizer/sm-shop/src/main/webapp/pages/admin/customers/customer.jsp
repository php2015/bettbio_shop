	...
	$.ajax({
	  ...
	  success: function(response){
			...
			if(status==0 || status ==9999) {
				...
				var data = response.response.status;
...
<div id="tabbable" class="tabbable">
				...
				<form:form method="POST" commandName="customer" action="${saveCustomer}">
					...
					<form:errors id="customer.error" path="*" cssClass="alert alert-danger" element="div" />
					<script type="text/javascript">
                          $(function(){
                              $(window).load(function(){
                                ...
                                if(temp=="success"){
                                   alert("要求成功完成!");
                                }else if($("#customerError").attr("style")=="display:none;"){
                                   alert("要求未完成!");
                                }
                              });
                          });
					...
					<div id="customerError" class="alert alert-danger" style="display:none;"></div>
			...
			<c:if test="${customerAttr.id!=null && customerAttr.id>0}">
	            ...
	            <div id="attributesError" class="alert alert-danger" style="display:none;"><s:message code="message.error" text="An error occured"/></div>
