...
<script type="text/javascript">
	...
	$(function(){
	  ...
	  if('${operator}'=="new") {
		  ...
		  window.parent.window.loadProductTab(2);
      ...
      <form:form method="POST" enctype="multipart/form-data" commandName="product" action="${productSave}" class="form-horizontal">
		<form:hidden path="product.id" />
                   	...
                   	<div class="row">
                   	  ...
                   	  <div class="col-sm-4">
                   	    <label><s:message code="label.instrumentedit.batchnum" text="Type"/>(且最多255位)</label>
                   ...
                   <div class="row">
                   	  ...
                   	  <div class="col-sm-4">
                   	    <label><s:message code="label.instrumentedit.cas" text="Made"/>(且最多255位)</label>
                      ...
                      <div class="collapse" id="collapseExample">
                   	...
                   	<c:forEach items="${product.descriptions}" var="description" varStatus="counter">
                   	  ...
                   	  <div class="col-sm-6">
                   	    ...
                   	    <form:input maxlength="255" cssClass="form-control" id="enName${counter.index}" path="descriptions[${counter.index}].enName" onkeyup="value=value.replace(/[\\u4E00-\\u9FA5\\uFF00-\\uFFFF]/g,'')" onafterpaste="value=value.replace(/[\\u4E00-\\u9FA5\\uFF00-\\uFFFF]/g,'')"/>
                   	  </div>
                   	</div>
