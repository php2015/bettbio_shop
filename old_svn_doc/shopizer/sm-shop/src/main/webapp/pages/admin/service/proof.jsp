...
$(function(){
	getStores(null,self,${product.id});
...
<div class="row">
	...
	<div id="p-title">
		...
		<form:form method="POST" commandName="proof" enctype="multipart/form-data" action="${saveProductProof}" cssClass="form-horizontal">
			...
			<div class="row">
				<div class="col-sm-6">
				 	<label><s:message code="label.service.proof.buyer" text="proof buyer"/></label>                   
				...
				<div style="width:50%;float:left;padding:0px 15px;">
					<label><s:message code="label.service.proof.dateBuyed" text="Date buyed"/></label>
