		...
		<tr>
			<td valign="top">
			  <div id="iamges" style="width:352px;height: 352px;">
				<c:choose>
					...
					<c:otherwise>
						<img src="<c:url value="/resources/img/02.png" />" style="max-width: 340px;max-height: 340px"/>
					</c:otherwise>
				</c:choose>	
				</div>
				<br/>
			 <div>
			   ...
			   <div id="imgUrl">
			    ...
			    <c:if test="${product.imagelength==0}">
			      <a href="javascript:void();" title="/resources/img/02.png""> <img id="" src="<c:url value="/resources/img/02.png"/>" style="max-width:60px;max-height:60px;margin-left: 2px" /></a>
			    </c:if>
			    </div>
			 </div>
			</td>
			<td style="width:550px;padding-left:30px;" valign="top">
				...
				<div style="padding-top:22px;font-size:14px;" class="pull-right">
					...
					<span><button style="height:40px;width:120px;" type="button" id="addCartButton" onclick="addcart()"; class="btn btn-large btn-danger " >加入购物车</button></span>
				            ...
				            <div role="tabpanel" class="tab-pane detailWidth" id="section-4">
				          	<div class="container" style=" padding-top:20px;">
								...
								<div class="col-sm-6" style="font-size:14px;">
									<div style="padding-botom:8px;"><s:message code="label.product.thirdproof.thirddetection" text="Thirdproof"/>：${thirdProof.displayName }</div>
									<div style="padding-botom:8px;"><s:message code="label.product.thirdproof.description" text="Thirdproof"/>：<div id="temp" style="height:10px;padding-bottom:10px;"><div style="font-weight:normal;">${thirdProof.description }</div></div></div>
			            		...
			            		<div class="container" style=" padding-top:20px;">
									<div class="">
										...
										<div class="col-sm-6" style="font-size:14px;padding-left:1px;">
											<div style="padding-bottom:10px;"><s:message code="label.product.proof.buyer" text="Thirdproof"/>：${proof.buyer }</div>
											<div style="padding-bottom:10px;"><s:message code="label.product.proof.dateBuyed" text="Thirdproof"/>：${proof.dateBuyed}</div>
											<div style="padding-bottom:10px;"><s:message code="label.product.proof.description" text="Thirdproof"/>：<div id="temp" style="padding-bottom:10px;height: 10px;"><div style="font-weight:normal;">${proof.description }</div></div></div>
...
jQuery(function($) {
  ...
  $(document).ready( function() {
	...
	//set cookie
  	var imageurl='/resources/img/02.png';
