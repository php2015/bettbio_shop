...
<div class="head-navbar-left" style="height:60px;">
	<div class="container-fluid">
	    ...
	    <c:if test="${ ptype=='customer'}">
	     <div class="col-md-2" style="width:500px;margin-top: 32px;size: 16px"><strong><span style="font-size:20px;color:#333333;">欢迎买家用户注册</span></strong><%-- <strong>${param.c=='customer'?"欢迎您进入普通用户注册":"欢迎您进入商家注册"}</strong> --%></div>
	     <div class="pull-right" style="margin-top: 35px;size: 16px">
	     <a href="<c:url value="storeinsertAdmin.html?c=store"/>" style="color:#4285f4">
	     <strong style="color:#4285f4;font-size:16px;"> 切换至${ptype=='customer'?'商家用户':'买家用户'}注册
	       <img src="<c:url value="/resources/ad/jiantou.png"/>" style="width:16px;height:16px;"/></a></c:if>
	     <c:if test="${ptype=='store'}">
	     <div class="col-md-2" style="width:500px;margin-top: 32px;size: 16px"><strong><span style="font-size:20px;color:#333333;">欢迎商家用户注册</span></strong><%-- <strong>${param.c=='customer'?"欢迎您进入普通用户注册":"欢迎您进入商家注册"}</strong> --%></div>
	     <div class="pull-right" style="margin-top: 35px;size: 16px">
