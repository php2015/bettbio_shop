...
<div style="text-align: center;"><img style="width:100%;height:68px;" alt="商家logo" src="${pageContext.request.contextPath}/file/showImage.html?path=${store.storeLogo }"  /></div>
<div style="width:100%;">
