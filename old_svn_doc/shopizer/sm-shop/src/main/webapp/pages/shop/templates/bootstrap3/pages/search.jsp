					...
					<table id="tr_td"  style="width:100%">
						<thead style="background-color: #f9f9f9;"> 
							<tr style="font-weight:bold;height:40px;">
								...
								<td colspan="2" width="40%" data-column-id="name" style="text-align: center;">
								   <s:message code="label.productedit.productname" text="Name"  />
								</td>
								
								<td width="10%" data-column-id="Brand" style="text-align: center;">
								...
								<td width="15%" data-column-id="quality" style="text-align: center;">
