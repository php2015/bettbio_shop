...
<div style="padding-bottom:0px;" id="login">
	  <ul class="nav nav-tabs" role="tablist">
	    ...
	    <li role="presentation" class="" id="storeActive" style="width:150px;text-align:center;"><a href="#stroelogin" aria-controls="profile" role="tab" data-toggle="tab" >商家用户</a></li>
	  </ul>
	<div id="customer_div">
