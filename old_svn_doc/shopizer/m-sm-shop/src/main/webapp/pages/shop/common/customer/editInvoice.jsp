				       ...
				       <form:hidden path="id"/>
						<form:errors id="invoice.error" path="*" cssClass="alert-danger" element="div" />
							<div class="form-group">
			                        <label class="col-xs-12 control-label"><s:message code="label.customer.billingtype" text="Transaction type"/>:</label>
			                        <div class="col-sm-10">
			                        	<div class="row">
			                        		<div class="col-xs-6"><form:radiobutton id="invoiceType" path="type" value="0" onclick="javascript:radiocheck(0)"  />&nbsp;<s:message code="label.customer.billingnormal" text="Normal" />		</div>
			                        		<div class="col-xs-6"><form:radiobutton id="invoiceType" path="type" value="1" onclick="javascript:radiocheck(1)" />&nbsp;<s:message code="label.customer.billingspecial" text="Special" /></div>
			                        	</div>
				          ...
				          <div id="special" style="display:none;" >
				            ...
				            <div class="form-group">
				            	<div class="col-sm-3 col-sm-offset-2">
			                        ...
			                        <div class="col-sm-3 col-sm-offset-2">
			                       		 <input id="submitInvoice" class="btn btn-info btn-disabled pull-right" type="submit"  name="submitInvoice" value="<s:message code="menu.editinvoice" text="Change Invoice"/>" disabled="">
			                        </div>			                        		                        
				            </div>   
