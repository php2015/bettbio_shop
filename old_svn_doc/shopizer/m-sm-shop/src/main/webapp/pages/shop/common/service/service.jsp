...
<div class="body">
	...
	<div>
		...
		<div id="proof" class="productdesc featurette productdesc-even-background">
			<div>
				<div class="productdesc-title"><s:message code="label.service.proof" text="Proof"/></div>
			</div>
			<div style="margin:0px 20px;">
				<c:choose>
					<c:when test="${not empty  product.productProofs}">
						<div class="row">
							...
							<div class="col-sm-6" style="font-weight:bold;font-size:14px;">
								<div><s:message code="label.service.proof.buyer" text="Thirdproof"/>:${proof.buyer }</div>
								<div><s:message code="label.service.proof.dateBuyed" text="Thirdproof"/></div>
