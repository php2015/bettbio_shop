   ...
   <form:form id="checkoutForm" method="POST" enctype="multipart/form-data" commandName="order" action="${commitUrl}">
			...
			<div class="row">
					...
					<div class="col-xs-12" style="padding-top: 3px;padding-bottom: 3px;height:auto;border-top:solid 1px #0080ff;"  >
										<span><s:message code="label.customer.shippinginformation" text="Shipping information"/></span></div>												
					...
					<div class="col-xs-2"  >
						<a style="color:#FF6C00;" href="javascript:void(0);" onclick="showModal()"><span aria-hidden="true" class="carticon fa fa-edit fa-2x icon" ></span></a>
					</div>
					<div class="col-xs-2" >
					...
					<div class="col-xs-2"  >
						<a style="color:#FF6C00;" href="javascript:void(0);" onclick="showInvoice()"><span aria-hidden="true" class="carticon fa fa-edit fa-2x icon" ></span></a>
					</div>
					<div class="col-xs-2" >
