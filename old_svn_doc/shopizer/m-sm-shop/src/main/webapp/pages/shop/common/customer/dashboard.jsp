...
<div class="container-fluid " style="background-color: #f6f6f6;">
	...
	<div class="row "  style="padding:10px;background-color: #ffffff;border-bottom:#f6f6f6 1px solid;">
		<div class="col-xs-3 text-center">
				 <a style="color:#800080" href="<c:url value="/shop/customer/orders.html?status=ORDERED"/>"><div><span class="carticon fa fa-truck fa-3x icon"/></div>
		  			<div>
		  				<s:message code="label.order.ORDERED" text="Ordered"/>
		  			</div> </a>		
		</div>
		<div class="col-xs-3 text-center">
				 <a style="color:rgb(22, 145, 190)" href="<c:url value="/shop/customer/orders.html?status=SHIPPED"/>"><div><span class="carticon fa fa-gift fa-3x icon"/></div>
		  			<div>
		  				<s:message code="label.order.SHIPPED" text="Shipped"/>
		  			</div> </a>		
		</div>
		<div class="col-xs-3 text-center">
				 <a style="color:#FF8C00" href="<c:url value="/shop/customer/orders.html?status=PAID"/>"><div><span class="carticon fa fa-credit-card fa-3x icon"/></div>
		  			<div>
		  				<s:message code="label.order.PAID" text="Paid"/>
		  			</div> </a>		
		</div>
		<div class="col-xs-3 text-center">
			 <a style="color:#B22222" href="<c:url value="/shop/customer/orders.html?status=REVIEW"/>"><div><span class="carticon fa fa-comments fa-3x icon"/></div>
		  			<div>
		  				<s:message code="label.generic.pre" text="Pre"/><s:message code="label.generic.comments" text="Comment"/>
		  			</div> </a>		
		</div>
	</div>
	<div class="row" style="padding:10px;background-color: #ffffff;border-bottom:#f6f6f6 1px solid;border-top:#f6f6f6 1px solid;">
