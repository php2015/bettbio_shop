...
<div class="container-fluid"> 	
	<div class="customer-box row">
		<div class="container-fluid" style="padding-bottom:10px;">
				<div class="pull-left" style="font-size:15px;padding-top:10px;"><s:message code="label.customer.safety.phone" text="Change phone"/></div>
				...
				<div class="col-xs-12 box main-padding-lr">
					...
					<form method="post" action="${changePhone}" id="changePhoneForm" class="form-horizontal">
						   <form:errors path="*" cssClass="alert-danger" element="div" />
							...
							<div class="form-group">
								<label class="col-xs-6 control-label" for="currentPhone"><s:message code="label.customer.currentphone" text="Current Phone"/>:</label>
								<div class="col-xs-6">
								   <span >${phone }</span>						
								</div>
							 </div>
							...
							<div class="form-group">
	                                     ...
	                                     <div class="col-sm-4">
	                                        		<input id="btnSendCode2" class="btn btn-info btn-block" type="button" value="<s:message code="label.generic.newphone.message" text="Phone"/>" onclick="sendPhoneMessage('2')" />
	                                        	</div>   
							</div>
							...
							<div class="form-group">
								<div class="col-sm-5 col-sm-offset-3">
									<input id="submitChangePhone" class="btn  btn-disabled btn-info btn-block" type="submit" name="changePhone" value="<s:message code="button.label.submit2" text="Change Phone"/>" disabled="">
								</div>
							</div>			
							</fieldset>				
						</form>
		...
		<div class="col-xs-12 ">
			<div id="store.success" class=" alert alert-success" style="<c:choose><c:when test="${success!=null}">display:block;</c:when><c:otherwise>display:none;</c:otherwise></c:choose>"><s:message code="message.success" text="Request successfull"/></div>
					<div id="formError"  class="alert alert-warning " style="display:none;position:fixed; top:57px;right:10px;"></div>
		</div>
		</div>
</div>