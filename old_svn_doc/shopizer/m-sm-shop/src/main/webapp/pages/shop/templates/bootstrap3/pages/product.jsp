			...
			<div class="col-xs-12">
					...
					<div class="row">
						...
						<div class="col-xs-6">
								...
								<label><s:message code="label.product.code" text="Product code"/>:</label>&nbsp;&nbsp;&nbsp;&nbsp; <span itemprop="identifier" style="color:#000;word-break: break-all;" content="mpn:${product.sku}">${product.sku}</span><br/>
