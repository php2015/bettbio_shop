...
<script src="<c:url value="/resources/js/jquery.printElement.min.js" />"></script>
	...
	<div class="row">
			<div class="col-xs-12">
				<h4><s:message code="label.order.details" text="Order details" />&nbsp;#&nbsp;<s:message code="menu.order" text="Order" /><s:message code="menu.order.no" text="No" />:<c:out value="${order.orderID}"/></h4>
...
<hr style="border-top:solid 1px #0080ff;">
			...
			<div class="col-xs-12" >
				<fmt:formatDate type="both" dateStyle="medium" value="${order.datePurchased}" />&nbsp;&nbsp;<s:message code="menu.order" text="Order"/><s:message code="label.entity.status" text="Status"/>:
		...
		<div class="col-xs-12" style="padding:10px;">
			...
			<strong><s:message code="label.customer.invoiceaddress" text="Shipping address" /></strong>
				...
				<c:forEach items="${order.subOrders}" var="subOrder">
					<div class="col-xs-8" >
						<s:message code="menu.store" text="Store"/>:${subOrder.merchantStore.storename}
					</div>	
					<div class="col-xs-4" >
					...
					<div class="col-xs-12" style="text-align:right;">
						<s:message code="menu.order" text="Order"/><s:message code="label.subtotal" text="Store"/>:<sm:monetary value="${subOrder.total}"/>
					</div>									
				</c:forEach>
