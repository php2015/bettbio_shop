 ...
 */
package com.bettbio.core.common.web.upload;
...
import com.bettbio.core.common.utils.LogUtils;
import com.bettbio.core.common.utils.security.Coder;
import com.bettbio.core.common.web.upload.exception.FileNameLengthLimitExceededException;
import com.bettbio.core.common.web.upload.exception.InvalidExtensionException;
...
public class FileUploadUtils {
    ...
    public static final String uploadImg(
        ...
        assertAllowed(file, DEFAULT_ALLOWED_EXTENSION, DEFAULT_MAX_SIZE);
        String filename = extractFilename(file, getDefaultBaseDir(),true);
