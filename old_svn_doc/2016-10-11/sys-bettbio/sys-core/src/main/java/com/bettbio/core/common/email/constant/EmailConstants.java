package com.bettbio.core.common.email.constant;
...
public class EmailConstants {
	...
	public final static String PRODUCT_AUDIT = "PRODUCT_AUDIT";
	public final static String PRODUCT_BETTER = "PRODUCT_BETTER";
	...
	public static final String ADDRESS_BILLING_INVOICE ="ADDRESS_BILLING_INVOICE";
	...
	public static final String EMAIL_AUDIT_TPL = "email_template_audit.ftl";
	...
	public static final String RESET_PASSWORD_TPL = "email_template_password_reset_customer.ftl";
	public final static String RESET_ACTIVE_TPL = "email_template_active_customer.ftl";
	
	public static final String TEST_EMAIL_TPL = "email_template_test.ftl";
	public static final String NEW_STORE_TMPL = "email_template_new_store.ftl";
}
