...
<!-- BODY -->
<table class="body-wrap" style="border-collapse:collapse">
	<!-- content header-->
	<tr>
		<td></td>
		<td>
			...
			<table>
				<tr>
					<td>
						<h4>${LABEL_HI} ${EMAIL_CUSTOMER_FIRSTNAME}</h4>
						<br/>
						<p>
							${EMAIL_ORDER_NUMBER}<br/>
							${EMAIL_ORDER_DATE}<br/>
							${EMAIL_ORDER_THANKS}
						</p>
					</td>
	...
	<tr>
		...
		<td>
			...
			<table>
				<tr>
					<td>
						<h4>${EMAIL_ORDER_DETAILS_TITLE}</h4> <br/>
						...
						<table>
							<tr>
								...
								<td>
									<h5>${ADDRESS_BILLING_INVOICE} &raquo;</h5>
									<p>
										${ADDRESS_DELIVERY}
									</p>
								</td>
